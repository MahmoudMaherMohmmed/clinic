            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box box-black">
                        <div class="box-title">
                            <h3><i class="fa fa-table"></i> @lang('messages.news.news')</h3>
                        </div>
                        <div class="box-content">
                            <div class="btn-toolbar pull-right">
                                <div class="btn-group">
                                    @if (get_action_icons('news/create', 'get')) 
                                        <a class="btn btn-circle show-tooltip" title=""
                                            href="{{ url('news/create') }}" data-original-title="Add new record"><i
                                        ...
                                        @foreach ($news as $value)
                                            <tr>
                                                ...
                                                <td class="visible-md visible-xs visible-sm visible-lg">
                                                    <div class="btn-group">
                                                        @if (get_action_icons('news/{id}/edit', 'get'))

                                                            <a class="btn btn-sm show-tooltip"
                                                                href='{{ url("news/$value->id/edit") }}'
                                                                title="Edit"><i class="fa fa-edit"></i></a>
                                                        @endif
                                                        @if (get_action_icons('news/{id}/delete', 'get'))
